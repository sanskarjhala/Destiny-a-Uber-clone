    ...
    <div>
      ...
      <div className='flex flex-col justify-between items-center gap-5'>
        ...
        <div className='w-full mt-5'>
            ...
            <div className='flex items-center gap-5 p-3 border-b-2'>
                ...
                <div>
                    ...
                    <p className='text-sm -mt-1 text-gray-600'>Kankariya Tabalb, Ahemdabad</p>
                </div>
            </div>
        ...
        onClick={() => {
          ...
          className='w-full mt-5 text-white font-semibold rounded-lg bg-green-600 p-2'>Confirm</button>
      </div>
